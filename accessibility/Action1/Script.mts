...
Browser("Skat.dk: Borger").Page("Skat.dk: Borger").Check CheckPoint("Skat.dk: Borger_2") @@ script infofile_;_ZIP::ssf15.xml_;_
Browser("Skat.dk: Borger").Page("Skat.dk: Borger").Link("FradragFx håndværkerfradrag,").Click @@ script infofile_;_ZIP::ssf14.xml_;_
Browser("Skat.dk: Borger").Page("Skat.dk: Indkomst og skat_2").Check CheckPoint("Skat.dk: Indkomst og skat_2") @@ script infofile_;_ZIP::ssf17.xml_;_
Browser("Skat.dk: Borger").Page("Skat.dk: Indkomst og skat_2").Link("Arbejdsrelaterede fradragKørse").Click @@ script infofile_;_ZIP::ssf16.xml_;_
Browser("Skat.dk: Borger").Page("Skat.dk: Indkomst og skat_2").Check CheckPoint("Skat.dk: Indkomst og skat_3") @@ script infofile_;_ZIP::ssf19.xml_;_
Browser("Skat.dk: Borger").Page("Skat.dk: Indkomst og skat_2").Link("Kørselsfradrag (befordringsfra").Click @@ script infofile_;_ZIP::ssf18.xml_;_
