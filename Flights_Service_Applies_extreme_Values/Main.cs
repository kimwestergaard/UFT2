/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘Flights_Service_Applies_extreme_Values.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Economy</Class><CustomerName p1:nil=""true""></CustomerName><DepartureDate>9999-12-31T23:59:59-23:59</DepartureDate><FlightNumber>2147483647</FlightNumber><NumberOfTickets>2147483647</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>Zurich</DepartureCity><ArrivalCity>Zurich</ArrivalCity><FlightDate>9999-12-31T23:59:59-23:59</FlightDate></GetFlights></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><GetFlightOrders xmlns=""HP.SOAQ.SampleApp""><FlightsDetails><CustomerName p1:nil=""true""></CustomerName><FlightDate>9999-12-31T23:59:59-23:59</FlightDate><OrderNumber>2147483647</OrderNumber></FlightsDetails></GetFlightOrders></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><UpdateFlightOrder xmlns=""HP.SOAQ.SampleApp""><UpdateFlightOrderDetails><Class>Economy</Class><CustomerName p1:nil=""true""></CustomerName><NumberOfTickets>2147483647</NumberOfTickets><OrderNumber>2147483647</OrderNumber></UpdateFlightOrderDetails></UpdateFlightOrder></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><DeleteFlightOrder xmlns=""HP.SOAQ.SampleApp""><OrderNumber>2147483647</OrderNumber></DeleteFlightOrder></Body></Envelope>");
