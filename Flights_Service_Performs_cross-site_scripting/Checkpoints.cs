    ...
    public partial class WorkFlowScript
    {
        ...
        private void set_StServiceCallActivity9_checkpoints(STActivityBase activity)
        {
            ...
            CpValObj ExpectedSchema = new CpValObj("<?xml version=\"1.0\" encoding=\"utf-16\"?><xs:schema xmlns=\"http://schemas.xmlsoap.o" +
                    ...
                    "s=\"lax\" /></xs:complexType><xs:element name=\"Body\" type=\"Body\" /><xs:complexType" +
                    " name=\"Body\"><xs:sequence xmlns=\"\"><xs:element xmlns:q1=\"HP.SOAQ.SampleApp\" ref=" +
                    "\"q1:DeleteAllFlightOrdersResponse\" /></xs:sequence><xs:anyAttribute namespace=\"#" +
                    "#any\" processContents=\"lax\"><xs:annotation><xs:documentation>Prose in the spec d" +
                    "oes not specify that attributes are allowed on the Body element</xs:documentatio" +
                    "n></xs:annotation></xs:anyAttribute></xs:complexType><xs:attribute name=\"mustUnd" +
                    "erstand\"><xs:simpleType><xs:restriction base=\"xs:boolean\"><xs:pattern value=\"0|1" +
                    "\" /></xs:restriction></xs:simpleType></xs:attribute><xs:attribute name=\"actor\" t" +
                    "ype=\"xs:anyURI\" /><xs:simpleType name=\"encodingStyle\"><xs:annotation><xs:documen" +
                    "tation>\'encodingStyle\' indicates any canonicalization conventions followed in th" +
                    "e contents of the containing element.  For example, the value \'http://schemas.xm" +
                    "lsoap.org/soap/encoding/\' indicates the pattern described in SOAP specification<" +
                    "/xs:documentation></xs:annotation><xs:list itemType=\"xs:anyURI\" /></xs:simpleTyp" +
                    "e><xs:attribute name=\"encodingStyle\" type=\"encodingStyle\" /><xs:attributeGroup n" +
                    "ame=\"encodingStyle\"><xs:attribute ref=\"encodingStyle\" /></xs:attributeGroup><xs:" +
                    "element name=\"Fault\" type=\"Fault\" /><xs:complexType name=\"Fault\" final=\"extensio" +
                    "n\"><xs:annotation><xs:documentation>Fault reporting structure</xs:documentation>" +
                    "</xs:annotation><xs:sequence><xs:element name=\"faultcode\" type=\"xs:QName\" /><xs:" +
                    "element name=\"faultstring\" type=\"xs:string\" /><xs:element minOccurs=\"0\" name=\"fa" +
                    "ultactor\" type=\"xs:anyURI\" /><xs:element minOccurs=\"0\" name=\"detail\" type=\"detai" +
                    "l\" /></xs:sequence></xs:complexType><xs:complexType name=\"detail\"><xs:sequence><" +
                    "xs:any minOccurs=\"0\" maxOccurs=\"unbounded\" namespace=\"##any\" processContents=\"la" +
                    "x\" /></xs:sequence><xs:anyAttribute namespace=\"##any\" processContents=\"lax\" /></" +
                    "xs:complexType></xs:schema>", XmlTypeCode.None);
            stracturalPropsInfo.Add(stracturalOutputEnvelope);
            BaseCPRule StracturalRule = new StracturalRule(activity, ExpectedSchema, stracturalPropsInfo);
            activity.AddCheckpointRule(StracturalRule);
