...
SAPGuiSession("Session").SAPGuiWindow("Change Standard Order").SAPGuiTable("All Items").SetCellData 1,"Order Quantity","250" @@ hightlight id_;_66_;_script infofile_;_ZIP::ssf4.xml_;_
